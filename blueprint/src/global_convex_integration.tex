...
\begin{proof}[Proof of Theorem~\ref{thm:open_ample}]
  ...
  homotopy $\H$ of sections of $J¹(E, E')$ with support in the closed ball $2B_E$
  and time independent for $t$ near $(-∞, 0] ∪ [1, +∞)$ (here by support we mean
  the closure of the set of points where $\H_t$ differs from $\F$).
  In order to ensure
  ...
  $‖\bs \H_t(e) - \bs \F(e)‖ < η$ for some positive $η$ given by
