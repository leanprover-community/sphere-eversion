...
\begin{lemma}
  ...
  \leanok
  % TODO: we need this (and formalized this) for the case where $f$ and $g$ have
  % parameters/are families of maps
...
\begin{proof}[Proof of Theorem~\ref{thm:open_ample}]
  ...
  lem:smooth_updating, lem:dist_updating, lem:loc_ultim_const,
  ...
  \Cref{lem:loc_ultim_const} to learn our sequence $F_n$ is locally
