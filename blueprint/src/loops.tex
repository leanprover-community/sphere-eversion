...
\begin{proof}
  ...
  Now we define a family $(δ^i)_{i \in ℕ}$ by $δ^0 = \rst{γ}{U_0}$ and
...
\begin{proof}[Proof of \Cref{prop:loops}]
  ...
  to ensure that $γ$ is constant in a neighborhood around
  $C = \{(t, s) \in [0,1] \times 𝕊^1 \mid t = 0 \vee s = 0\}$.
  By a partition of unity argument, we can find a smooth function
  ...
  $K$ and equals one near $E ∖ U^*$. As our final family of loops,
  we choose $(1-χ(x))g(x) + χ(x)(γ_x ∘ h_x)$. This
