...
In this section, we explain how to construct families of loops to feed into the
...
All of this section is devoted to proving the following proposition.
...
process in the next section, but also brings a ``satisfied or refund'' guarantee,
