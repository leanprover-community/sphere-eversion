...
\begin{proof}
  ...
  Carathéodory's lemma \Cref{lem:caratheodory} provides affinely independent
  ...
  lemma \Cref{lem:int_homothety_cvx} to $\Conv(\hat b)$ we see:
  \begin{align*}
...
\begin{proof}
  ...
  $(x, 0)$.
  This means that $γ{0,x'}^{ρ(τ)t'}$ tends uniformly to the constant function $s ↦ β(x)$
